...
const useFilters = () => {
    ...
    setFilters((prev) => {
      ...
      if (found) {
        newState = prev.filter(
          (f) => f.forSearchKey == found.forSearchKey && f.val != found.val
        );
      } else {
  ...
  const clearFilterFor = (forKey: FILTER_KEY) => {
    setFilters((prev) => {
      return prev.filter((f) => f.forSearchKey != forKey);
    });
  };
...
function ListPostPage() {
  ...
  useEffect(() => {
    getUser().then(({ data }) => setFilteredUsers(data));
  }, []);
    ...
    const r = data
      ...
      .filter((a: any) => {
        ...
        return filters.length != 0
          ? filters.some((f) => a.town?.startsWith(f))
          : true;
      })
      .filter((a: any) => {
        const filters = getValuesFiltersFor(FILTER_KEY.SERVICE);
        return filters.length != 0
          ? filters.some((f) => a.services?.find((s: any) => s.name == f))
          : true;
      });
    setFilteredUsers([...r]);
  }, [filters, data]);
      ...
      <div className="container page-content">
        <div className="row">
                    ...
                    <div className="form-group">
                      ...
                      <div className="checkbox">
                        <label>
                          <input
                            onChange={() => {
                              addValueFor(FILTER_KEY.GENDER, "Male");
                            }}
                            type="checkbox"
                          />
                      ...
                      <div className="checkbox">
                        <label>
                          <input
                            onClick={() => {
                              addValueFor(FILTER_KEY.GENDER, "Female");
                            }}
                            type="checkbox"
                          />
                      ...
                      <div className="checkbox">
                        <label>
                          <input
                            onClick={() => {
                              addValueFor(FILTER_KEY.GENDER, "Couple");
                            }}
                            type="checkbox"
                          />
                      ...
                      <div className="checkbox">
                        <label>
                          <input
                            onClick={() => {
                              addValueFor(FILTER_KEY.GENDER, "Trans");
                            }}
                            type="checkbox"
                          />
                      ...
                      <div className="checkbox">
                        <label>
                          <input
                            onClick={() => {
                              addValueFor(FILTER_KEY.ORIENTATION, "Bi-curious");
                            }}
                            type="checkbox"
                          />
                      ...
                      <div className="checkbox">
                        <label>
                          <input
                            onClick={() => {
                              addValueFor(FILTER_KEY.ORIENTATION, "Bi-sexual");
                            }}
                            type="checkbox"
                          />
                      ...
                      <div className="checkbox">
                        <label>
                          <input
                            onClick={() => {
                              addValueFor(FILTER_KEY.ORIENTATION, "Gay");
                            }}
                            type="checkbox"
                          />
                      ...
                      <div className="checkbox">
                        <label>
                          <input
                            onClick={() => {
                              addValueFor(FILTER_KEY.ORIENTATION, "Straight");
                            }}
                            type="checkbox"
                          />
                        ...
                        return (
                          <div key={t} className="checkbox">
                            <label>
                              <input
                                onClick={() => {
                                  addValueFor(FILTER_KEY.LOCATION, t);
                                }}
                                type="checkbox"
                              />
                        ...
                        return (
                          <div key={t.name} className="checkbox">
                            <label>
                              <input
                                onClick={() => {
                                  addValueFor(FILTER_KEY.SERVICE, t.name);
                                }}
                                type="checkbox"
                              />
          ...
          <div className="col-md-7 col-xs-12">
            <div
              className="col-inside-lg decor-default activities animated fadeInUp"
              id="activities"
            >
              {loading && (
                <p
